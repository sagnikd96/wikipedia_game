...
class UserLogicTests(unittest.TestCase):
    ...
    def test5(self):
        a = lg.Problem("a", "A", 1, 40, 0.5)
        b1 = lg.UserLogic("a", "A", 100)
        b2 = lg.UserLogic("b", "b", 70)
    ...
    def test7(self):
        ...
        b1 = lg.UserLogic("user1", "User1", 100)
        ...
        result = "user1 ::: User1 ::: 100 ::: 0 ::: 0 ::: 0 ::: ['a', 'b', 'c', 'd'] ::: ['c', 'd'] ::: [a, user1, 120 :: b, user1, 120]"
        self.assertTrue(str(b1) == result)

    def test8(self):
        a = "user1 ::: User1 ::: 100 ::: 0 ::: 0 ::: 0 ::: ['a', 'b', 'c', 'd'] ::: ['c', 'd'] ::: [a, user1, 120 :: b, user1, 120]"
        result = ["user1", "User1", 100, 0, 0, 0, ["a", "b", "c", "d"], ["c", "d"], [("a", "user1", 120), ("b", "user1", 120)]]
    ...
    def test9(self):
        ...
        b1.solutions_bought = [a3, a4]
        b1.solutions_sold = [c1, c2]
        expected = ["user1", "User1", 100, 0, 0, 0, ["a", "b", "c", "d"], ["c", "d"], [("a", "user1", 120), ("b", "user1", 120)]]
...
class CommodityTests(unittest.TestCase):
    ...
    def test1(self):
        ...
        b1 = lg.UserLogic("a", "A", 100)
        b2 = lg.UserLogic("a", "b", 100)
        b3 = lg.UserLogic("b", "A", 100)
        c1 = lg.Commodity(a1, b1, 120)
